...
/**
 * Represents a Patch that is not on hold, in regression or broken.
 */
public class OpenPatch extends Patch implements HtmlTableRow, Comparable<OpenPatch> {
    ...
    OpenPatch(String jiraLink, String name, String productName, String assignee, State state,
              ...
              String signRequestSentOn) {

        super(jiraLink, name, productName, assignee, state, patchLCState, patchQueueId, reportDate, signRequestSentOn);
