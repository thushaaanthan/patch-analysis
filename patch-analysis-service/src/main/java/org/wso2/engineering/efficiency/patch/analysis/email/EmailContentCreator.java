...
import org.wso2.engineering.efficiency.patch.analysis.utils.Constants;

import java.util.ArrayList;
import java.util.Collections;

import static org.wso2.engineering.efficiency.patch.analysis.utils.Constants.Email.COLUMN_NAMES;
import static org.wso2.engineering.efficiency.patch.analysis.utils.Constants.Email.COLUMN_NAMES_DEV;
import static org.wso2.engineering.efficiency.patch.analysis.utils.Constants.Email.COLUMN_NAMES_INACTIVE;
import static org.wso2.engineering.efficiency.patch.analysis.utils.Constants.Email.COLUMN_NAMES_RELEASED;
import static org.wso2.engineering.efficiency.patch.analysis.utils.Constants.Email.COLUMN_NAMES_SUMMARY;
import static org.wso2.engineering.efficiency.patch.analysis.utils.Constants.Email.EMAIL_FOOTER;
import static org.wso2.engineering.efficiency.patch.analysis.utils.Constants.Email.SECTION_HEADER_DEV;
import static org.wso2.engineering.efficiency.patch.analysis.utils.Constants.Email.SECTION_HEADER_INACTIVE;
...
public class EmailContentCreator {
    ...
    /**
     * Build the html string for the Summary table.
     *
    ...
    /**
     * Extract all inactive patches.
     *
     * @param jiraIssues ArrayList of JIRA issues
     * @return an ArrayList of all inactive patches.
     */
    ...
    /**
     * Extract all Open Patches.
     *
     * @param jiraIssues ArrayList of JIRA issues
     * @return an ArrayList of all open patches.
     */
     ...
     * @param dateColumnName name of "date" column in table.
     * @param patches        ArrayList of patches.
     * @return String containing code for a HTML table.
     */
     ...
     *
     * @param rows ArrayList of issues or patches.
    ...
    /**
     * Build the html table with information on released Patches.
     *
     * @param jiraIssues all JIRA issues.
    ...
    /**
     * Extract JIRAs that have released Patches.
     *
     * @param jiraIssues all JIRA issues.
    ...
    /**
     * Build the table body with information on Released Patches.
     *
     * @param jiraIssues ArrayList of Jira issues.
     * @return html code for the row values of table.
     */
